...
export function AWSVerifyEmail({
        ...
        <Container style={container}>
          <Section style={coverSection}>
            <Section style={imageSection}>
              <Img src={baseUrl} width="75" height="70" alt="Notion's Logo" />
            </Section>
...
export function renderAWSVerifyEmail(props: AWSVerifyEmailProps) {
  return render(<AWSVerifyEmail {...props} />);
}
